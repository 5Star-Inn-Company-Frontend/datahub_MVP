        ...
        >
          ...
          <li className="relative">
            <a
              ...
              data-te-sidenav-link-ref
            >
              <span className="mr-4 [&>svg]:h-4 [&>svg]:w-4  [&>svg]:transition [&>svg]:duration-300 [&>svg]:ease-linear group-hover:[&>svg]:border-[#ff5718]-600 group-focus:[&>svg]:border-[#ff5718]-600 group-active:[&>svg]:border-[#ff5718]-600 group-[te-sidenav-state-active]:[&>svg]:border-[#ff5718]-600 motion-reduce:[&>svg]:transition-none dark:[&>svg]:fill-gray-300 dark:group-hover:[&>svg]:fill-gray-300 ">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
                  viewBox="0 0 24 24"
            ...
            >
              <li className="relative">
                <a
                  ...
                  onClick={() => router.push("/user_module")}
                >
                  All Users
                </a>
              </li>
          ...
          <li className="relative">
            <a
              ...
              data-te-sidenav-link-ref
            >
              <span className="mr-4 [&>svg]:h-4 [&>svg]:w-4  [&>svg]:transition [&>svg]:duration-300 [&>svg]:ease-linear group-hover:[&>svg]:border-[#9333ea]-600 group-focus:[&>svg]:border-[#ff5718]-600 group-active:[&>svg]:border-[#ff5718]-600 group-[te-sidenav-state-active]:[&>svg]:border-[#ff5718]-600 motion-reduce:[&>svg]:transition-none dark:[&>svg]:fill-gray-300 dark:group-hover:[&>svg]:fill-gray-300 ">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
                  viewBox="0 0 24 24"
