...
import { AirtimeApiObjectType } from "./airtime";
import { ModifyAirtime } from "@/actions/serviceModule/server";
...
export function ModifyAirtimemodal({
    id,
    data
}:ModifyPropType) {
    ...
    return (
      <Dialog open={open} onOpenChange={setOpen}>
        ...
        <DialogContent className="sm:max-w-[425px] bg-white">
          <DialogHeader>
            <DialogTitle>Modify Airtime</DialogTitle>
            <DialogDescription>
    ...
    <Drawer open={open} onOpenChange={setOpen}>
      ...
      <DrawerContent className="bg-white p-4">
        <DrawerHeader className="text-left">
          <DrawerTitle>Modify Airtime</DrawerTitle>
          <DrawerDescription>
            {/* Edit user's informations. */}
          </DrawerDescription>
        </DrawerHeader>
        ...
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-2">
            ...
            {/* <FormField
              ...
              render={({ field }) => (
                  ...
                  <FormControl>
                      <Input placeholder="server" {...field} type="text"/>
                  </FormControl>
                  <FormMessage />
                  </FormItem>
              )}
