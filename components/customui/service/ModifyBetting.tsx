...
import { BettingApiObjectType } from "./betting";
import { ModifyBetting } from "@/actions/serviceModule/server";
...
export function ModifyBettingmodal({
    id,
    data
}:ModifyPropType) {
    ...
    return (
      <Dialog open={open} onOpenChange={setOpen}>
        ...
        <DialogContent className="sm:max-w-[425px] bg-white">
          <DialogHeader>
            <DialogTitle>Modify Betting</DialogTitle>
            <DialogDescription>
    ...
    <Drawer open={open} onOpenChange={setOpen}>
      ...
      <DrawerContent className="bg-white p-4">
        <DrawerHeader className="text-left">
          <DrawerTitle>Modify Betting</DrawerTitle>
          <DrawerDescription>
            {/* Edit user's informations. */}
          </DrawerDescription>
        </DrawerHeader>
